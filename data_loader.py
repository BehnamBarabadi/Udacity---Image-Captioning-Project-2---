...
def get_loader(transform,
               ...
               num_workers=0,
               cocoapi_loc=r'D:\Google Drive\Jupyter Notebooks\Udaicity - Computer Vision\Project 2 - Image-Captioning-Project-master'):
    ...
    Args:
      ...
      cocoapi_loc: The location of the folder containing the COCO API folder: https://github.com/cocodataset/cocoapi
    """
    ...
    if mode == 'train':
        ...
        img_folder = os.path.join(
            cocoapi_loc, 'D:/No Backup/COCO/images/train2014/')
        annotations_file = os.path.join(
            cocoapi_loc, 'D:/No Backup/COCO/annotations/captions_train2014.json')
    if mode == 'test':
        ...
        img_folder = os.path.join(
            cocoapi_loc, 'D:/No Backup/COCO/images/test2014/')
        annotations_file = os.path.join(
            cocoapi_loc, 'D:/No Backup/COCO/annotations/annotationsimage_info_test2014.json')
